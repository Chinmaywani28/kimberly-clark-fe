...
import GaugeChart from './guage-chart';


ChartJS.register(CategoryScale, LinearScale, PointElement, LineElement, Tooltip, Legend);

const SmallCardGuage = ({ Data }) => {
  ...
  return (
    <Card sx={{ ...styles.thinBorder, width: 300, height: '300px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 4, borderRadius: '20px', bgcolor: tempCheck.bgColor, borderColor: tempCheck.borderColor, borderWidth: 2 }}>
     ...
     <Box sx={{ display: 'flex',justifyContent : 'center', flexDirection: 'column', gap: 2.5, }}>
        <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center', color: tempCheck.colors, position: 'relative', left: 0, gap: 1, bottom: 30, top: 10 }}>
